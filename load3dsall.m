function [header, I, dIdV, voltage, midV, QPI] = load3dsall(fn, sigma)
...
% filtered dIdV data. The Fourier transform of the dIdV data is taken, and
% stored in QPI array.
...
for i = 1:(points - 1)
    midV(i,1) = voltage(i,1) + (voltage(i+1,1) - voltage(i,1))/2;
end
